...
class ProfileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Map.ProfileTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Profile';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Profile';
     ...
     */
    const COL_ID = 'profile.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'profile.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ProfileTableMap::COL_ID, ProfileTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ProfileTableMap::COL_ID => 0, ProfileTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Profile');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProfileTableMap::COL_ID);
            $criteria->addSelectColumn(ProfileTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Profile) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ProfileTableMap::DATABASE_NAME);
            $criteria->add(ProfileTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ProfileTableMap::COL_ID) && $criteria->keyContainsValue(ProfileTableMap::COL_ID) ) {
